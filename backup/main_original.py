...
from settings import (
    TRACKER_FILE, DEFAULT_INTERVAL, TRACE_PATH,
    GUISettings, QBittorrentConfig, NetworkSettings, 
    ScraperSettings, LoggingSettings, DialogSettings,
    TestSettings
)
...
class App:
    ...
    def _setup_search_panel(self):
        ...
        self.search_results_tree = ttk.Treeview(self.search_results_frame, 
                                              columns=('Episode', 'Size', 'DateTime', 'Seeders', 'Leechers'), 
                                              show='tree headings', height=15)
        self.search_results_tree.heading('#0', text='Title')
        self.search_results_tree.heading('Episode', text='Ep')
        self.search_results_tree.heading('Size', text='Size')
        self.search_results_tree.heading('DateTime', text='Date/Time')
        self.search_results_tree.heading('Seeders', text='S')
        self.search_results_tree.heading('Leechers', text='L')
        
        self.search_results_tree.column('#0', width=250)
        self.search_results_tree.column('Episode', width=50)
        self.search_results_tree.column('Size', width=80)
        self.search_results_tree.column('DateTime', width=120)
        self.search_results_tree.column('Seeders', width=40)
        self.search_results_tree.column('Leechers', width=40)
